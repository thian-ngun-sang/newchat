...
const updateAccount = async(req, res) => {
    const user = req.user;
    const { first_name, last_name, user_name, email, phone, gender, address } = req.body;
...
module.exports = { updateAccount, updatePassword, updateProfileImage, updateCoverImage, account, peerAccount };
